...
class ExclusiveShopsAdapter : ListAdapter<Shop, ExclusiveShopsAdapter.ShopsViewHolder>(ShopsComparator) {
    ...
    override fun onBindViewHolder(holder: ShopsViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val action = HomeFragmentDirections.actionHomeFragmentToViewShopFragment(sell)
