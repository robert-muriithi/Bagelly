...
class MobilePhoneShopsAdapter : ListAdapter<Shop, MobilePhoneShopsAdapter.MobilePhoneViewHolder>(ShopsComparator) {
    class MobilePhoneViewHolder(private val binding: ExclusiveShopsItemLayoutBinding) : RecyclerView.ViewHolder(binding.root){
        fun bind(shop: Shop?){
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): MobilePhoneViewHolder {
        return MobilePhoneViewHolder(ExclusiveShopsItemLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }

    override fun onBindViewHolder(holder: MobilePhoneViewHolder, position: Int) {
