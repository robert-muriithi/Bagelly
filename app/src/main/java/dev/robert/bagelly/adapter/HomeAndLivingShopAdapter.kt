...
class HomeAndLivingShopAdapter : ListAdapter<Shop, HomeAndLivingShopAdapter.HomeLivingViewHolder>(ShopsComparator) {
    class HomeLivingViewHolder(private val binding: ExclusiveShopsItemLayoutBinding) : RecyclerView.ViewHolder(binding.root){
        fun bind(shop: Shop?){
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): HomeLivingViewHolder {
        return HomeLivingViewHolder(ExclusiveShopsItemLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }

    override fun onBindViewHolder(holder: HomeLivingViewHolder, position: Int) {
