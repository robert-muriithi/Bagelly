...
interface MainRepository {
    ...
    suspend fun getOtherStores(
        result: (Resource<List<Shop>>) -> Unit
    )

    suspend fun getMotorcycleAndVehicleDealers(
        result: (Resource<List<Shop>>) -> Unit
    )

    suspend fun getServiceProvidersShops(
        result: (Resource<List<Shop>>) -> Unit
    )

    suspend fun getFarmInputStores(
        result: (Resource<List<Shop>>) -> Unit
    )
    ...
    suspend fun deleteSinglePost(
        post: Post, result: (Resource<Post>) -> Unit
    )
    ...
    suspend fun getExclusiveStores(
        result: (Resource<List<Shop>>) -> Unit
    )
    ...
    suspend fun deleteAllFavouriteItems(
        result: (Resource<List<Sell>>) -> Unit
    )

    suspend fun getCurrentUserSells(
        result: (Resource<List<Sell>>) -> Unit
    )
